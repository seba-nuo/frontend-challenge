...
function Card(product: productsProps) {
  ...
  return (
    <li className="flex justify-center p-3 mt-6 cursor-pointer lg:px-6">
      <div className="relative flex flex-col items-center w-36 justify-between hover:bg-ligthterGray lg:w-44">
        <div className="flex flex-col items-center">
          <img className="h-32 w-44" src={product.imageUrl} alt={product.productName} />
          {
            product.listPrice &&
