...
function Hero() {
  return (
    <header className="relative mt-6">
      <img className="object-fit" src={hero} alt="hero" />
      ...
      <div className='absolute top-0 left-0 p-6 w-full h-full'>
        ...
        <h2 className="text-white text-3xl font-bold">Crear o migrar tu comercio electrónico?</h2>
        <div className='flex absolute bottom-2 left-0 w-full justify-center'>
